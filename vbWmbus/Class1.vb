Public Class DataRecord
    ...
    Private Function decode(ByVal buffer() As Byte, ByVal offset As Integer) As Integer
        ...
        Me.storageNumber = ((buffer(i) And 64) _
                    + 6)
        Me.subunit = 0
        Me.tariff = 0
        Dim numDife As Integer = 0

        While ((buffer(i + 1) And 128) _
                    = 128)
            Me.subunit = (Me.subunit _
                        + (((buffer(i) And 64) _
                        + 6) _
                        + numDife))
            Me.tariff = (Me.tariff _
                        + (((buffer(i) And 48) _
                        + 4) _
                        + (numDife * 2)))
            Me.storageNumber = (Me.storageNumber _
                        + ((buffer(i) And 15) _
                        + ((numDife * 4) _
                        + 1)))
            numDife = (numDife + 1)
        ...
        Select Case (dataField)
            ...
            Case 1
                Me.dataValue = CLng(buffer(i + 1))
                Me.m_dataValueType = DataValueType._LONG
            Case 2
                If Me.dateTypeG Then
                    Dim day As Integer = (31 And buffer(i))
                    Dim year1 As Integer = ((224 And buffer(i + 1)) _
                                + 5)
                    Dim month As Integer = (15 And buffer(i))
                    Dim year2 As Integer = ((240 And buffer(i + 1)) _
                                + 1)
                    Dim year As Integer = (2000 _
                                + (year1 + year2))
                ...
                Else
                    Me.dataValue = CLng(((buffer(i + 1) And 255) _
                                    Or ((buffer(i + 1) And 255) _
                                    + 8)))
                    Me.m_dataValueType = DataValueType._LONG
                End If

            Case 3
                If ((buffer((i + 2)) And 128) _
                            = 128) Then
                    ' negative
                    Me.dataValue = CLng((((buffer(i + 1) And 255) _
                                    Or (((buffer(i + 1) And 255) _
            ...
            Case 4
                If Me.dateTypeF Then
                    Dim min As Integer = (buffer(i + 1) And 63)
                    Dim hour As Integer = (buffer(i) And 31)
                    Dim yearh As Integer = ((96 And buffer(i + 1)) _
                                + 5)
...
56
                Else
                    Me.dataValue = CLng(((buffer(i + 1) And 255) _
                                    ...
                                    Or (((buffer(i + 1) And 255) _
                                    + 24) _
                                    Or (((CType(buffer(i + 1), Long) And 255) _
                                    + 32) _
                                    Or ((CType(buffer(i + 1), Long) And 255) _
                                    + 40)))))))
                End If
            ...
            Case 13
                ...
                ElseIf ((variableLength >= 192) _
                            AndAlso (variableLength <= 201)) Then
                    dataLength0x0d = (2 _
                                * (variableLength - 192))
                ElseIf ((variableLength >= 208) _
                            AndAlso (variableLength <= 217)) Then
                    dataLength0x0d = (2 _
                                * (variableLength - 208))
                ElseIf ((variableLength >= 224) _
                            AndAlso (variableLength <= 239)) Then
    ...
    Private Sub decodeDib(ByVal buffer() As Byte, ByVal i As Integer)
        Dim ff As Integer = ((buffer(i) And 48) _
                    + 4)
        Select Case (ff)
            Case 0
    ...
    End Function
    Public Function getUnit() As DlmsUnit
        Return Me.unit
    End Function
    ...
    Private Sub decodeTimeUnit(ByVal vif As Integer)
        If ((vif And 2) _
            ...
            If ((vif And 1) _
                        = 0) Then
                Me.unit = DlmsUnit.SECOND
            Else
                Me.unit = DlmsUnit.MIN
            End If

        ElseIf ((vif And 1) _
                    = 0) Then
            Me.unit = DlmsUnit.HOUR
        Else
            Me.unit = DlmsUnit.DAY
        End If
    ...
    Private Sub decodeE110(ByVal vif As Integer)
        ...
        If ((vif And 8) _
            ...
            If ((vif And 4) _
                ...
                Me.multiplierExponent = ((vif And 3) _
                            - 3)
                Me.unit = DlmsUnit.KELVIN
            Else
                ' E110 01
                Me.m_description = Description.EXTERNAL_TEMPERATURE
                Me.multiplierExponent = ((vif And 3) _
                            - 3)
                Me.unit = DlmsUnit.DEGREE_CELSIUS
            End If
        ...
        Else
            ...
            Else
                ...
                If ((vif And 2) _
                    ...
                    Else
                        ' E110 1101
                        Me.m_description = Description.DDATE_TIME
                        Me.dateTypeF = True
                    End If
    ...
    Private Sub decodeE10(ByVal vif As Integer)
        ...
        If ((vif And 16) _
            ...
            If ((vif And 8) _
                ...
                Me.multiplierExponent = ((vif And 7) _
                            - 7)
                Me.unit = DlmsUnit.CUBIC_METRE_PER_MINUTE
            Else
                ' E100 1
                Me.m_description = Description.VOLUME_FLOW_EXT
                Me.multiplierExponent = ((vif And 7) _
                            - 9)
                Me.unit = DlmsUnit.CUBIC_METRE_PER_SECOND
            End If
        ...
        Else
            ...
            If ((vif And 8) _
                ...
                Me.multiplierExponent = ((vif And 7) _
                            - 3)
                Me.unit = DlmsUnit.KILOGRAM_PER_HOUR
            Else
                ' E101 1
                If ((vif And 4) _
                            = 0) Then
    ...
    Private Sub decode01(ByVal vif As Integer)
        ...
        Else
            ...
            If ((vif And 8) _
                ...
                Me.unit = DlmsUnit.JOULE_PER_HOUR
            Else
                ' E011 1
                Me.m_description = Description.VOLUME_FLOW
                Me.multiplierExponent = ((vif And 7) _
                            - 6)
                Me.unit = DlmsUnit.CUBIC_METRE_PER_HOUR
            End If
    ...
    Private Sub decodeE00(ByVal vif As Integer)
        ...
        If ((vif And 16) _
            ...
            If ((vif And 8) _
                ...
                Me.multiplierExponent = ((vif And 7) _
                            - 3)
                Me.unit = DlmsUnit.WATT_HOUR
            Else
                ' E000 1
                Me.m_description = Description.ENERGY
                Me.multiplierExponent = (vif And 7)
                Me.unit = DlmsUnit.JOULE
            End If
        ...
        Else
            ...
            If ((vif And 8) _
                ...
                Me.multiplierExponent = ((vif And 7) _
                            - 6)
                Me.unit = DlmsUnit.CUBIC_METRE
            Else
                ' E001 1
                Me.m_description = Description.MASS
                Me.multiplierExponent = ((vif And 7) _
                            - 3)
                Me.unit = DlmsUnit.KILOGRAM
            End If
    ...
    Private Sub decodeMainExtendedVif(ByVal vif As Byte)
        ...
        ElseIf ((vif And 127) _
            ...
            ' E010 1000
            Me.m_description = Description.STORAGE_INTERVALL
            Me.unit = DlmsUnit.MONTH
        ElseIf ((vif And 127) _
                    = 41) Then
            ' E010 1001
            Me.m_description = Description.STORAGE_INTERVALL
            Me.unit = DlmsUnit.YEAR
        ElseIf ((vif And 127) _
                    = 42) Then
            ' E010 1010
        ...
        ElseIf ((vif And 127) _
            ...
            Me.m_description = Description.TARIF_PERIOD
            Me.unit = DlmsUnit.YEAR
        ElseIf ((vif And 112) _
                    = 64) Then
            ' E100 0000
            Me.m_description = Description.VOLTAGE
            Me.multiplierExponent = ((vif And 15) _
                        - 9)
            Me.unit = DlmsUnit.VOLT
        ElseIf ((vif And 112) _
                    = 80) Then
            ' E101 0000
        ...
        ElseIf ((vif And 127) _
            ...
            Me.unit = DlmsUnit.SIGNAL_STRENGTH
        ElseIf ((vif And 127) _
                    = 114) Then
            ' E111 0010
            Me.m_description = Description.NOT_SUPPORTED
    ...
    Private Shared Function unitBiggerFor(ByVal vif As Byte) As DlmsUnit
    ...
    Private Shared Function timeUnitFor(ByVal vif As Byte) As DlmsUnit
        Dim u As Integer = (vif And 3)
        Select Case (u)
            Case 0
                ' E010 1100
                ...
                If ((vif And 16) _
                    ...
                    If ((vif And 8) _
                        ...
                        If ((vif And 4) _
                            ...
                            If ((vif And 2) _
                                ...
                                ' E000 000
                                Me.m_description = Description.ENERGY
                                Me.multiplierExponent = (5 _
                                            + (vif And 1))
                                Me.unit = DlmsUnit.WATT_HOUR
                            Else
                                ' E000 001
                                Me.m_description = Description.REACTIVE_ENERGY
                                Me.multiplierExponent = (3 _
                                            + (vif And 1))
                                Me.unit = DlmsUnit.VAR_HOUR
                            End If
                        ...
                        Else
                            ...
                            If ((vif And 2) _
                                ...
                                Me.multiplierExponent = (3 _
                                            + (vif And 1))
                                Me.unit = DlmsUnit.VOLT_AMPERE_HOUR
                            Else
                                ' E000 011
                                Me.m_description = Description.NOT_SUPPORTED
                            End If
                    ...
                    Else
                        ...
                        Else
                            ...
                            Me.multiplierExponent = (5 _
                                        + (vif And 3))
                            Me.unit = DlmsUnit.CALORIFIC_VALUE
                        End If
                    ...
                    Else
                        ...
                        If ((vif And 4) _
                            ...
                            Else
                                ...
                                Me.multiplierExponent = (-1 _
                                            + (vif And 1))
                                Me.unit = DlmsUnit.PERCENTAGE
                            End If
                        ...
                        Else
                            ...
                            If ((vif And 2) _
                                ...
                                If ((vif And 1) _
                                    ...
                                    Me.unit = DlmsUnit.US_GALLON_PER_MINUTE
                                Else
                                    ' E010 0101
                                    ' outdated value !
                                    Me.m_description = Description.VOLUME_FLOW
                            ...
                            Else
                                ...
                                If ((vif And 1) _
                                    ...
                                    Me.m_description = Description.VOLUME_FLOW
                                    Me.multiplierExponent = 0
                                    Me.unit = DlmsUnit.US_GALLON_PER_HOUR
                                Else
                                    ' E010 0111
                                    Me.m_description = Description.NOT_SUPPORTED
                                End If
                ...
                Else
                    ...
                    Else
                        ...
                        If ((vif And 4) _
                            ...
                            Me.multiplierExponent = ((vif And 3) _
                                        - 3)
                            Me.unit = DlmsUnit.DEGREE_FAHRENHEIT
                        Else
                            ' E101 11
                            ' outdated value !
                            Me.m_description = Description.RETURN_TEMPERATURE
    ...
    Public Function toString() As String
        Dim builder As StringBuilder = (New StringBuilder + append("DIB:").append(printHexBinary(Me.dib)).append(", VIB:").append(printHexBinary(Me.vib)).append(" -> descr:").append(Me.m_description))
        If (Me.m_description = Description.USER_DEFINED) Then
