Public Class EnumerazioniWMBus
    ...
    Private Sub decodeDib(ByVal buffer() As Byte, ByVal i As Integer)
        ...
        Select Case (ff)
            Case 0
                Me.m_functionField = FunctionField.Valore_Istantaneo
            Case 1
                Me.m_functionField = FunctionField.Valore_Massimo
            Case 2
                Me.m_functionField = FunctionField.Valore_Minimo
            Case 3
                Me.m_functionField = FunctionField.Valore_Errore
            Case Else
