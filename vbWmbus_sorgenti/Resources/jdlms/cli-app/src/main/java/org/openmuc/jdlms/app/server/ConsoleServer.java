...
public class ConsoleServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StringCliParameter password = new CliParameterBuilder("-pass").setDescription(
        ...
        IntCliParameter inactivityTimeout = new CliParameterBuilder("-it")
                .setDescription("The inactivity timeout in ms.")
                .buildIntParameter("inactivity_timeout", 0);
