...
public final class AssociationSnClass extends CosemSnInterfaceObject {
    ...
    @CosemAttribute(id = 2, accessMode = READ_ONLY, type = ARRAY, selector = { CLASS_ID_ACCESS,
            CLASS_ID_BASE_NANE_ACCESS, BASE_NAME_ACCESS }, snOffset = 0x08)
    private DataObject objectList;

    @CosemAttribute(id = 3, accessMode = READ_ONLY, type = ARRAY, selector = { BASE_NAME_ACCESS }, snOffset = 0x10)
    private DataObject accessRightsList;

    @CosemAttribute(id = 4, accessMode = READ_ONLY, type = OCTET_STRING, snOffset = 0x18)
    private DataObject securitySetupReference;

    @CosemAttribute(id = 5, accessMode = READ_ONLY, type = ARRAY, snOffset = 0x20)
    private DataObject userList;

    @CosemAttribute(id = 6, accessMode = READ_ONLY, type = STRUCTURE, snOffset = 0x28)
    ...
    @CosemMethod(id = 3, accessMode = ACCESS, snOffset = 0x30)
