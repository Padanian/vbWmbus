...
public class SecuritySetup extends CosemSnInterfaceObject {
    ...
    @CosemAttribute(id = 2, accessMode = AUTHENTICATED_READ_ONLY, snOffset = 0x08)
    private DataObject securityPolicy;

    @CosemAttribute(id = 3, accessMode = AUTHENTICATED_READ_ONLY, snOffset = 0x10)
    private DataObject securitySuite;

    @CosemAttribute(id = 4, accessMode = AUTHENTICATED_READ_ONLY, snOffset = 0x18)
    private DataObject clientSystemTitle;

    @CosemAttribute(id = 5, accessMode = AUTHENTICATED_READ_ONLY, snOffset = 0x20)
    ...
    @CosemMethod(id = 2, consumes = Type.ARRAY, accessMode = MethodAccessMode.AUTHENTICATED_ACCESS, snOffset = 0x30)
