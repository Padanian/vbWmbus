...
/**
 * This class contains the methods defined for IC ExtendedRegister.
 * 
 * @deprecated since 1.5.1. Use the none enum initializer of {@link org.openmuc.jdlms.MethodParameter}.
 */
@Deprecated
public enum ExtendedRegisterMethod implements MethodClass {
    RESET(1, false);
    ...
    private ExtendedRegisterMethod(int methodId, boolean mandatory) {
