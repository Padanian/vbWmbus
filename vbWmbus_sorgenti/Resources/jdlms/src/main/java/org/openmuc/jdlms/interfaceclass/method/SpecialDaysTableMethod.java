...
/**
 * This class contains the methods defined for IC SpecialDaysTable.
 * 
 * @deprecated since 1.5.1. Use the none enum initializer of {@link org.openmuc.jdlms.MethodParameter}.
 */
@Deprecated
public enum SpecialDaysTableMethod implements MethodClass {
    INSERT(1, false),
    DELETE(2, false);
    ...
    private SpecialDaysTableMethod(int methodId, boolean mandatory) {
