...
/**
 * This class contains the methods defined for IC Register.
 * 
 * @deprecated since 1.5.1. Use the none enum initializer of {@link org.openmuc.jdlms.MethodParameter}.
 */
@Deprecated
public enum RegisterMethod implements MethodClass {
    RESET(1, false);
    ...
    private RegisterMethod(int methodId, boolean mandatory) {
