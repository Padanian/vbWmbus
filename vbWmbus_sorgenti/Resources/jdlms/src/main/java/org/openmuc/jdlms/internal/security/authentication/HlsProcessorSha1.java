...
/**
 * Implementation of HIGH Level authentication using SHA-1 hashing as described in IEC 62056-6-2
 */
public class HlsProcessorSha1 implements HlsSecretProcessor {
    ...
    public byte[] process(byte[] challenge, SecuritySuite securitySuite, byte[] systemTitle, int frameCounter)
        ...
        return MdShaProcessor.process(challenge, securitySuite, "SHA1");
    }
