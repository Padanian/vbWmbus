...
public class SelectiveAccessDescription {
     ...
     */
    public SelectiveAccessDescription(int accessSelector, DataObject accessParameter) {
    ...
    public String toString() {
        return String.format("{\"selector\": %d, \"parameter\": %s}", this.accessSelector, this.accessParameter);
    }
