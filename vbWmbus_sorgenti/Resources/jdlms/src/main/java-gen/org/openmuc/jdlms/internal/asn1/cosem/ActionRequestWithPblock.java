...
public class ActionRequestWithPblock implements AxdrType {
    ...
    public ActionRequestWithPblock() {
    }

    public ActionRequestWithPblock(byte[] code) {
        this.code = code;
    }

    public ActionRequestWithPblock(InvokeIdAndPriority invokeIdAndPriority, DataBlockSA pBlock) {
    ...
    public String toString() {
        return "sequence: {" + "invokeIdAndPriority: " + invokeIdAndPriority + ", pBlock: " + pBlock + "}";
    }
