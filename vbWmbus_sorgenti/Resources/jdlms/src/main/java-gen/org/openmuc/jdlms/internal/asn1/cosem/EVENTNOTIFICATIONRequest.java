...
public class EVENTNOTIFICATIONRequest implements AxdrType {
    ...
    public AxdrOptional<CosemDateTime> time = new AxdrOptional<>(new CosemDateTime(), false);
    ...
    public EVENTNOTIFICATIONRequest(CosemDateTime time, CosemAttributeDescriptor cosemAttributeDescriptor,
            Data attributeValue) {
    ...
    public int decode(InputStream iStream) throws IOException {
        ...
        time = new AxdrOptional<>(new CosemDateTime(), false);
